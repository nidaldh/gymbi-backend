...
class CustomerController extends Controller
{
    ...
    {
        $customer = CustomerModel::findOrFail($id);
        $customer->unpaid_Amount = $customer->getUnpaidOrdersAmount();
    ...
    public function getCustomers()
    {
        ...
        $customers = CustomerModel::where('store_id', $storeId)->orderBy('createdOn', 'desc')->get();
    ...
    {
        $customer = CustomerModel::findOrFail($id);
        $orders = OrderModel::where('customerId', $id)->with('orderProducts', 'orderTransactions')->get();
